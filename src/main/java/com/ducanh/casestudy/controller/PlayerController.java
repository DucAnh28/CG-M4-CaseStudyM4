...
////        AppUser appUser = IAppUserRepo.(id);
//        AppUser appUser = IAppUserRepo.findById(id).get();
//       // appUser.setGmail(playerEditNew.get()
//        // .getGmail());
////        appUser.setPassword(pa.encode(playerEditNew.get().getPassword()));
